package sorting.visualizer.Algo;
...
public class Display extends Canvas implements Runnable {
	...
	public Display() {
		...
		picture = new Picture("/images/lion.png");
	...
	private void update() {
		if(!sorted) {
			//modify bubble-sort to any other-sorting method for use.
			sorted = MasterSorter.sort(myPixels, SortingMethod.BubbleSort, 80000);
		}
	}
